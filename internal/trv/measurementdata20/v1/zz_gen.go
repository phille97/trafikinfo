...
type MeasurementData20 struct {
	...
	IRIRight float64 `xml:"IRIRight"`
	// SV: Mätbilens hastighet.
	MeasurementVehicleSpeed float64 `xml:"MeasurementVehicleSpeed"`
	...
	EdgeDepth float64 `xml:"EdgeDepth"`
	// SV: Megatextur höger. Enhet mm.
	MegatextureRight float64 `xml:"MegatextureRight"`
	// SV: Megatextur vänster. Enhet mm.
	MegatextureLeft float64 `xml:"MegatextureLeft"`
	...
	MPDMacrotextureRight float64 `xml:"MPDMacrotextureRight"`
	...
	MPDMacrotextureMiddle float64 `xml:"MPDMacrotextureMiddle"`
	...
	MPDMacrotextureLeft float64 `xml:"MPDMacrotextureLeft"`
	...
	RutBottomDistance float64 `xml:"RutBottomDistance"`
	...
	RutWidthRight float64 `xml:"RutWidthRight"`
	...
	RutWidthLeft float64 `xml:"RutWidthLeft"`
	// SV: Spårdjup höger15. Enhet mm. 15 lasrar.
	RutDepthRight15 float64 `xml:"RutDepthRight15"`
	// SV: Spårdjup höger17. Enhet mm. 17 lasrar.
	RutDepthRight17 float64 `xml:"RutDepthRight17"`
	// SV: Spårdjup max15. Maxvärde 15 lasrar.
	RutDepthMax15 float64 `xml:"RutDepthMax15"`
	// SV: Spårdjup max17. Maxvärde 17 lasrar.
	RutDepthMax17 float64 `xml:"RutDepthMax17"`
	// SV: Spårdjup vänster17. Enhet mm. 17 lasrar.
	RutDepthLeft17 float64 `xml:"RutDepthLeft17"`
	// SV: Spårbottentvärfall. Enhet %.
	CrossfallRutBottom float64 `xml:"CrossfallRutBottom"`
